...
- ✍️ Writing on [Medium](https://medium.com/@swarnsinghaulakh)
- 📰 Publishing on [Substack](https://swaransinghaulakh.substack.com/)
...
- Built analytics tracking pipelines for **Tesco Category Page** interactions using **New Relic dashboards** and **custom event tracking**, enabling data-driven **A/B testing** and product insights
- Led cross-team collaboration with **backend, product, and design teams** to deliver scalable Android UI features (**Seller Native Page, Popular Brands, Marketplace Bestsellers**) using **Jetpack Compose, GraphQL, and MVVM**, improving UI modularity and development speed
